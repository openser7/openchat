...
localStorage.rutaBase = rutabase;
var socketOmnichannel = null;
urlSocket = "https://empresarial.openser.com:81";
...
function socket() {
    ...
    socketOmnichannel._emit = function (name, data) {
        if (!data) data = {};
        data.idEnterprise = localStorage.idEnterprise;
    ...
    socketOmnichannel.on('empresa', function (empresa) {
        localStorage.idEnterprise = empresa;
    })
    ...
    socketOmnichannel.on('connect', function () {
        ...
        localStorage.idEnterprise = localStorage.idEnterprise;
        ...
        var data = {
            openser: _CveUsuario, idEnterprise: localStorage.idEnterprise, name: _NombreCompleto,
            source: _source,
